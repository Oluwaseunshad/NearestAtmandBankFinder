...
public class WemaBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wemabanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.wemaSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				WemaBankAtms.this.adapter.getFilter().filter(cs);
			}
