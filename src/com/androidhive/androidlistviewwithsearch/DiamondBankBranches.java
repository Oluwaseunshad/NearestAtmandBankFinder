...
public class DiamondBankBranches extends ListActivity {
	String [] branches = {
			/*
			 * List of Diamond Bank branches in Lagos State
			 */
	...
	setContentView(R.layout.diamondbankbranches);
	...
	inputSearch.addTextChangedListener(new TextWatcher() {
		...
		public void onTextChanged(CharSequence cs, int arg1, int arg2,
			...
			DiamondBankBranches.this.adapter.getFilter().filter(cs);
		}
