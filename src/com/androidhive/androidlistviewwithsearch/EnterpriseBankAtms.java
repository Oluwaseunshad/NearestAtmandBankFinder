...
public class EnterpriseBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.enterprisebanksatms);

		// Listview Data
		String atms[] = { 
				/*
				 * List of all Access Bank ATMs in Lagos
				 */
		...
		inputSearch = (EditText) findViewById(R.id.enterpriseSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				EnterpriseBankAtms.this.adapter.getFilter().filter(cs);
			}
