...
public class SterlingBankBranches extends ListActivity {
	String [] branches = {
	...
	setContentView(R.layout.sterlingbankbranches);
	...
	inputSearch.addTextChangedListener(new TextWatcher() {
		...
		public void onTextChanged(CharSequence cs, int arg1, int arg2,
			...
			SterlingBankBranches.this.adapter.getFilter().filter(cs);
		}
