...
public class UnionBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.unionbanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.unionSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				UnionBankAtms.this.adapter.getFilter().filter(cs);
			}
