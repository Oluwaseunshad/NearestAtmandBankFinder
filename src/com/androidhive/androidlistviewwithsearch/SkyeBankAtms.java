...
public class SkyeBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.skyebanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.skyeSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				SkyeBankAtms.this.adapter.getFilter().filter(cs);
			}
