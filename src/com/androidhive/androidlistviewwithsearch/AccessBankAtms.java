...
public class AccessBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.accessbanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.accessSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				AccessBankAtms.this.adapter.getFilter().filter(cs);
			}
