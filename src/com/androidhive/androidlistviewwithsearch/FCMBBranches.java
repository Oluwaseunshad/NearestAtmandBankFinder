...
public class FCMBBranches extends ListActivity {
	String [] branches = {
			/*
			 * List of FCMB Bank branches in Lagos State
			 */
	...
	setContentView(R.layout.fcmbbranches);
	...
	inputSearch.addTextChangedListener(new TextWatcher() {
		...
		public void onTextChanged(CharSequence cs, int arg1, int arg2,
			...
			FCMBBranches.this.adapter.getFilter().filter(cs);
		}
