...
public class KeystoneBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.keystonebanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.keystoneSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				KeystoneBankAtms.this.adapter.getFilter().filter(cs);
			}
