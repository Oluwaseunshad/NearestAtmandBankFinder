...
public class MainstreetBankBranches extends ListActivity {
	String [] branches = {
			...
			"Tincan Island Cash Office\nBehind Customs Long Room, Tincan Island",
	...
	setContentView(R.layout.mainstreetbankbranches);
	...
	inputSearch.addTextChangedListener(new TextWatcher() {
		...
		public void onTextChanged(CharSequence cs, int arg1, int arg2,
			...
			MainstreetBankBranches.this.adapter.getFilter().filter(cs);
		}
