...
public class EcoBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ecobanksatms);

		// Listview Data
		String atms[] = { 
				/*
				 * List of all Eco Bank ATMs in Lagos
				 */
		...
		inputSearch = (EditText) findViewById(R.id.ecoSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				EcoBankAtms.this.adapter.getFilter().filter(cs);
			}
