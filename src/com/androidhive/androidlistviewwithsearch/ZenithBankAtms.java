...
public class ZenithBankAtms extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zenithbanksatms);
		...
		inputSearch = (EditText) findViewById(R.id.zenithSearch);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence cs, int arg1, int arg2,
				...
				ZenithBankAtms.this.adapter.getFilter().filter(cs);
			}
